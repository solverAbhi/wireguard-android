...
package com.abhi.vpn.backend;

import android.os.SystemClock;

import com.abhi.crypto.Key;
import com.abhi.util.NonNullForAll;
...
public class Statistics {
     ...
     * @param rxBytes           The received traffic for the {@link com.abhi.config.Peer} referenced by
     *                          the provided {@link Key}. This value is in bytes
     * @param txBytes           The transmitted traffic for the {@link com.abhi.config.Peer} referenced by
     *                          the provided {@link Key}. This value is in bytes.
     * @param latestHandshake   The timestamp of the latest handshake for the {@link com.abhi.config.Peer}
    ...
    /**
     * Get the statistics for the {@link com.abhi.config.Peer} referenced by the provided {@link Key}
     *
     * @param peer A {@link Key} representing a {@link com.abhi.config.Peer}.
